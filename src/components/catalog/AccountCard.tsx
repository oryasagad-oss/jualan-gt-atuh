          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {account.isAvailable ? (
              <a
                ...
                className="px-3 py-2 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white text-xs font-bold flex items-center justify-center gap-1.5 shadow-pixel-blue transition-all"
              >
