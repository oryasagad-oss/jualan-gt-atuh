        ...
        <div className="lg:col-span-7 text-center lg:text-left z-10">
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 sm:gap-4 mb-8">
            ...
            <a
              ...
              className="px-4 sm:px-5 py-3 sm:py-3.5 bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold rounded-xl shadow-pixel-blue transition-all active:translate-y-1 flex items-center gap-2 text-xs sm:text-sm cursor-pointer"
